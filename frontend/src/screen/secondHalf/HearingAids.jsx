        ...
        <CardHeader>
          <div className="overflow-hidden rounded-lg">
            <img
              ...
              src="https://psrihospital.com/wp-content/uploads/2023/07/Hearing-aid-is-the-boon-for-those-who-are-impaired.webp"
            />
          </div>
        </CardHeader>
        <CardContent>
          <p className="font-semibold">
            Help by donating Hearing Aid to deaf people
          </p>
          <Progress
                ...
                <div className="flex justify-between">
                  <div>
                    <Card className="w-[350px]">
                      <CardHeader>
                        <div className="overflow-hidden rounded-lg">
                          <img src="https://psrihospital.com/wp-content/uploads/2023/07/Hearing-aid-is-the-boon-for-those-who-are-impaired.webp" />
                        </div>
                      </CardHeader>
                    </Card>
                  </div>
