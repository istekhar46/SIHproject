        ...
        <CardHeader>
          <div className="overflow-hidden rounded-lg">
            <img
              ...
              src="https://img.freepik.com/premium-photo/child-adult-holding-money-jar-donation-saving-concept_49149-1117.jpg"
            />
          </div>
        </CardHeader>
        <CardContent>
                ...
                <div className="flex justify-between">
                  <div>
                    <Card className="w-[350px]">
                      <CardHeader>
                        <div className="overflow-hidden rounded-lg">
                          <img src="https://img.freepik.com/premium-photo/child-adult-holding-money-jar-donation-saving-concept_49149-1117.jpg" />
                        </div>
                      </CardHeader>
                    </Card>
                  </div>
